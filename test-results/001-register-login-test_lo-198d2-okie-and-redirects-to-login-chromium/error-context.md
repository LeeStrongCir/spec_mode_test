...
- Name: 001-register-login/test_logout_flow.spec.ts >> SC-04: Logout Flow >> TC-020: logout clears cookie and redirects to login
- Location: tests/e2e/001-register-login/test_logout_flow.spec.ts:17:7
...
- generic [ref=e1]:
  - generic [ref=e4]:
    ...
    - generic [ref=e9]:
      ...
      - textbox "username" [ref=e12]: testuser_e2e_1778554669300
    - generic [ref=e13]:
      - generic [ref=e14]: Email
      - textbox "you@example.com" [ref=e16]: testuser_e2e_1778554669300@example.com
    - generic [ref=e17]:
