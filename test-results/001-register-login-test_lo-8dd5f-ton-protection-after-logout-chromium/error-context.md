...
- Name: 001-register-login/test_logout_flow.spec.ts >> SC-04: Logout Flow >> TC-021: browser back button protection after logout
- Location: tests/e2e/001-register-login/test_logout_flow.spec.ts:24:7
...
- generic [ref=e1]:
  - generic [ref=e4]:
    ...
    - generic [ref=e9]:
      ...
      - textbox "username" [ref=e12]: testuser_e2e_1778554669775
    - generic [ref=e13]:
      - generic [ref=e14]: Email
      - textbox "you@example.com" [ref=e16]: testuser_e2e_1778554669775@example.com
    - generic [ref=e17]:
